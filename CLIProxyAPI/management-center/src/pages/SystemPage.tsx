...
import { IconGithub, IconBookOpen, IconExternalLink, IconCode, IconDownload } from '@/components/ui/icons';
      ...
      <Card title={t('system_info.quick_links_title')}>
        ...
        <div className={styles.quickLinks}>
          ...
          <a
            ...
            className={styles.linkCard}
          >
            <div className={`${styles.linkIcon} ${styles.desktop}`}>
              <IconDownload size={22} />
            </div>
            <div className={styles.linkContent}>
              <div className={styles.linkTitle}>
                {t('system_info.link_desktop')}
                <IconExternalLink size={14} />
              </div>
              <div className={styles.linkDesc}>{t('system_info.link_desktop_desc')}</div>
            </div>
          </a>
        </div>
      </Card>
