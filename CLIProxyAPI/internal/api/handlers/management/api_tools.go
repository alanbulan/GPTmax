...
const (
	geminiOAuthClientID     = "GOOGLE_OAUTH_CLIENT_ID_PLACEHOLDER"
	geminiOAuthClientSecret = "GOOGLE_OAUTH_CLIENT_SECRET_PLACEHOLDER"
)
...
const (
	antigravityOAuthClientID     = "GOOGLE_OAUTH_CLIENT_ID_PLACEHOLDER"
	antigravityOAuthClientSecret = "GOOGLE_OAUTH_CLIENT_SECRET_PLACEHOLDER"
)
